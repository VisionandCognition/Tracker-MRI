...
Stm.FixT = 700; % time to fix before stim onset
Stm.KeepFixT = 150; % time to fix before target onset. before 26-9-2014 this was 150
    ...
    elseif TarCreateAlgorithm == 3
        ...
        for AlgoTargets=1
            ...
            for c=1:length(Stm.PolarAngles);
                ...
                Stm.Cond(c).Targ(1).Reward = 0.200;
