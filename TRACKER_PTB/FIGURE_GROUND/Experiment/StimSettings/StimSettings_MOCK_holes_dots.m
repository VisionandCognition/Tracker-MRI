...
Stm.StimType{2} = 'dots'; % lines / dots / dots_text
...
Stm.FileName = 'MOCK_FigGnd_holes_dots.mat';
...
% -
Stm.Fig(3) = Stm.Fig(1);
Stm.Fig(3).ishole = true;
% -
Stm.Fig(4) = Stm.Fig(2);
Stm.Fig(4).ishole = true;
...
Stm.PreDur_TRs = 1;%5; % volumes
Stm.PostDur_TRs = 1;%5; % volumes
Stm.nRepeatsStimSet = 1;%6; % 0=unlimited
