...
Stm(1).Position{2} = [-10 -8]; % deg from center (-=left/down)
Stm(1).Position{3} = [+10 -8]; % deg from center (-=left/down)
Stm(1).Position{4} = [-10 +8]; % deg from center (-=left/down)
Stm(1).Position{5} = [+10 +8]; % deg from center (-=left/down)
...
Stm(1).SwitchDur = 100; % duration of alternative orientation
