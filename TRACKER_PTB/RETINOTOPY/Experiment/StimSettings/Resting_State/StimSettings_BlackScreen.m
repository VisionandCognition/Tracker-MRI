...
% Background --------------------------------------------------------------
Stm(1).BackColor = 0*[.5 .5 .5]; % [R G B] 0-1
...
Stm(1).FixDotCol = 0*[1 0 0;1 0 0]; %[RGB if not fixating; RGB fixating]
...
% Logfolder
Stm(1).LogFolder = 'C:\Users\NINuser\Documents\Log_CK\Retinotopy\RestingState';
