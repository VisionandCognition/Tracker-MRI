...
Par.ResponseBox.Task = 'Fixate'; % doesn't matter as long as it's not DetectGoSignal
...
Par.PostErrorDelay = 4000; % extra wait time as punishment for error trials
Par.DelayOnMiss = 3000; % extra wait time as punishment for miss trials 

Par.NoIndicatorDuringPunishDelay=false;

Par.ProbSideRepeatOnCorrect = 0.5;
Par.ProbSideRepeatOnError = 0.7;
Par.ProbSideRepeatOnMiss = 0.8;
Par.ProbSideRepeatOnEarly = 0.50;

Par.CatchBlock.do = true;
Par.CatchBlock.AfterNumberOfTrials = 50;
Par.CatchBlock.NoCorrectPerSideNeeded = 2;
