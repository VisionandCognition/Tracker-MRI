%StimSettings
global StimObj
% The main goal of this stage is to get the subject used to the hand
% response indicator to be away from the fixation point (and the position
% independent of which hand he needs to respond with).
% Subject will also need to get used to the ambiguous response place holder
% during the pre-switch phase.
% The main variable to change is PawIndPositions
...
Stm(1).UnattdAlpha = [0 0.1]; % min should go to 1, with better training
...
% Stm(1).PawIndSize = 1; % Easy setting
Stm(1).PawIndSize = 0.3;
