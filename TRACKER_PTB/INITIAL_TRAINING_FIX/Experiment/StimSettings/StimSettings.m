...
Stm(1).Gap1_deg = [0 gap1];
Stm(1).Gap2_deg = [gap1 Stm(1).BranchDistDeg + gap2];
Stm(1).CurveTargetDistDeg = 2.5;
...
Stm(1).SwitchDur = 1200; % (200) duration of alternative orientation
