...
Stm(1).UnattdAlpha = [0 6];
Stm(1).UnattdAlpha_TargetAtFix = [0 1];
...
Stm(1).PawIndCol = [0 .65 0; 1 0 0]; % colors for the left and right target
...
Stm(1).SwitchDur = 500; % (200) duration of alternative orientation
...
%Stm(1).EventPeriods = [10*1000 0 100];
